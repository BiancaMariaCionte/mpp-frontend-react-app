...
export function UserCard({givenUser, removeMethod}: UserCardPropsType) {
    ...
    useEffect(() => {
        ...
        const videoId = extractVideoId(givenUser.youtubeUrl);
        const thumbnailUrl = `https://img.youtube.com/vi/${videoId}/hqdefault.jpg`;
        setThumbnailUrl(thumbnailUrl);
    }, [givenUser.youtubeUrl]);
            ...
            <Card data-testid='user-card' onClick={handleCardOnClick}>
                ...
                <CardContent>
                    <Typography gutterBottom variant='h5' component='div'>
                        {givenUser.instructorName}
                    </Typography>
                    <Typography variant='body2' color='text.secondary'>
                        {givenUser.type}
                    </Typography>
                    <Typography variant='body2' color='text.secondary'>
                        {givenUser.difficulty}
                    </Typography>
                </CardContent>
                <CardActions>
                    <Button
...
//             <div className='instructor-name'><b>Instructor's Name:</b> {givenUser.instructorName}</div>
//             <div className='type'><b>Type:</b> {givenUser.type}</div>
//             <div className='youtubeUrl'><b>YouTube Link:</b> <a href={givenUser.youtubeUrl} target='_blank' rel='noopener noreferrer'>{givenUser.youtubeUrl}</a></div>
//             <div className='difficulty'><b>Difficulty:</b> {givenUser.difficulty}</div>
//         </div>
//     </div>
